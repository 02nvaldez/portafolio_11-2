...
<body>
    <div class="hero-header">
        <div class="wrapper">
            ...
            <div class=" container">
                <div class="hero-pic">
                    <img src="https://th.bing.com/th/id/OIP.q2LtL2NYKRYjOy1Bg3PJmwHaFa?rs=1&pid=ImgDetMain">
                </div>
                <div class="hero-text">
                    <h1>CMS v.s FRAMEWORK</h1><br>
                    <p>En el contexto del desarrollo frontend, la diferencia principal entre un CMS (Sistema de Gestión
                        de Contenidos) y un framework radica en su propósito y enfoque:</p><br>

                    <p>1. CMS (Sistema de Gestión de Contenidos):</p><br>
